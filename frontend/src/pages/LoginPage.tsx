...
export function LoginPage() {
  ...
  const { login, loginWithOAuth, isLoading, error, clearError, isAuthenticated } = useAuthStore();
          ...
          <div className="glass-card p-8">
            ...
            <div className="text-center mb-8">
              <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-accent-cyan/20 to-accent-blue/20 flex items-center justify-center">
                <LogIn className="w-8 h-8 text-accent-cyan" />
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 glass-panel text-gray-400 rounded-full py-1">
                  or continue with
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                disabled={isLoading}
                className="flex items-center justify-center gap-2 px-4 py-3 glass-button text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
